...
public interface Carrito_de_compras_Service {
    ...
    public List<Carrito_de_compras> findByComprador(long compradorId);
    public Carrito_de_compras createCarrito_de_compras(Carrito_de_compras carrito_de_compras);
    public Carrito_de_compras editCarrito_de_compras(Carrito_de_compras carrito_de_compras, long id);
